...
function activate(context) {
    ...
    let serverOptions = {
        run: { command: serverExe, args: [context.extensionPath  + '\\Server\\LanguageServer.dll'] },
        debug: { command: serverExe, args: [context.extensionPath  + '\\Server\\LanguageServer.dll'] }
    };
    let clientOptions = {
        documentSelector: [
            {
